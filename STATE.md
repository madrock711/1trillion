...
## 최신 기준 · 2026-08-11 09:22 KST

- 최신 보고서: `reports/2026-08-11.md`
- 시장 상태: 한국 정규장 오전 장중
- KOSPI 6,226.84(-1.16%), KODEX 레버리지 88,355원(-2.66%)
- 외국인 현물 +821억원, 기관 -1,457억원, 개인 +752억원
- 프로그램 차익 +90억원, 비차익 -598억원, 전체 -509억원
- 달러/원 1,418.00원
- 오늘 판단: 공격 25 / 관망 55 / 방어 20
- 기본 6,200~6,349, 강세 6,350~6,475, 약세 6,100~6,199
- 다음 이벤트: 8월 12일 21:30 KST 미국 7월 CPI
- 새 변수: WTI +5.03%, 미국 10년물 4.70%, SOX -2.94%
- 유지 변수: AI 인프라 금융 확대와 서버 DRAM 공급 제약은 중기 메모리 수요를 지지
- 직전 전망 평가: 8월 10일 확정 종가·최종 수급 실제값은 정적 원장 미보존으로 아직 정산하지 않음
