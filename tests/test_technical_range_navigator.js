...
assert(amplifyRules.includes('TQQQ?range=1y&interval=1d'), 'TQQQ 일봉 원자료도 1년이어야 한다.');
assert(amplifyRules.includes('/market-data/stock/122630/history/price-5'), 'KODEX 일봉은 약 1년치까지 페이지를 확장해야 한다.');
