...
URLS = {
    ...
    "KOSDAQ-basic": "https://m.stock.naver.com/api/index/KOSDAQ/basic",
    "KOSDAQ-integration": "https://m.stock.naver.com/api/index/KOSDAQ/integration",
...
def fetch(item):
    ...
    try:
        ...
        record = {"url": url, "fetchedAt": datetime.datetime.now(datetime.timezone(datetime.timedelta(hours=9))).isoformat(timespec="seconds"), "rawHash": hashlib.sha256(raw).hexdigest(), "data": json.loads(raw)}
