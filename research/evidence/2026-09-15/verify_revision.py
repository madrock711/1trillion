...
seal = json.loads((e / "seal-revision.json").read_text(encoding="utf-8"))
fid = seal["forecastId"]
...
dump(e / "deployment-verification-revision.json", {"commitSha": commit, "jobId": job, "verifiedAt": now, "checks": checks})
...
dump(root / "research/evaluation/publications" / f"{fid}-deploy_verified.json", dict(common, eventType="deploy_verified", occurredAt=now, publicUrl="https://www.hpmplab.com/articles/market-2026-09-15.html", availabilityStatus="available"))
