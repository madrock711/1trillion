...
import concurrent.futures,datetime,hashlib,json,pathlib,subprocess,urllib.request,sys
...
dump(root/'research/evaluation/publications'/f'{fid}-deploy_verified.json',dict(common,eventType='deploy_verified',occurredAt=now,publicUrl='https://www.hpmplab.com/articles/market-2026-09-09.html',availabilityStatus='available'))
