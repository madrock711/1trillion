...
pairs = [
    ...
    for path in [
        "articles/market-2026-09-18.html",
        "assets/data/market-dashboard-latest.json",
        f"assets/data/market-dashboard-{seal['snapshotId']}.json",
        "assets/images/articles/market-2026-09-18-chip-rebound-foreign-flow-1200x630.webp",
        "charts/us_yield_spreads_90d_2026-09-18.png",
        "charts/us_yield_spreads_long_term_2026-09-18.png",
...
dump_new(
    root / "research/evaluation/publications" / f"{forecast_id}-deploy_verified.json",
    {
        ...
        "occurredAt": now,
        "publicUrl": "https://www.hpmplab.com/articles/market-2026-09-18.html",
